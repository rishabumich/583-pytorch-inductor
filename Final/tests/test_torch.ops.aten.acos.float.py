...
#sys.stdout = open("output_torch.ops.aten.acos.float.txt", "w")

# Define a module with the operator
class Torch_Ops_Aten_Acos_FloatModule(torch.nn.Module):
    def forward(self,a):
        return torch.ops.aten.acos.float(a)

# Instantiate the model
mod = Torch_Ops_Aten_Acos_FloatModule()
