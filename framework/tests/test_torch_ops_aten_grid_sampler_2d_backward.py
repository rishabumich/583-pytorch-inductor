...
class Torch_Ops_Aten_GridSampler2DBackwardModule(torch.nn.Module):
    def forward(self, grad_output, input, grid, interpolation_mode, padding_mode, align_corners, output_mask):
        return torch.ops.aten.grid_sampler_2d_backward(grad_output, input, grid, interpolation_mode, padding_mode, align_corners, output_mask)

mod = Torch_Ops_Aten_GridSampler2DBackwardModule()
