...
class Torch_Ops_Aten_Div_ScalarModeModule(torch.nn.Module):
    def forward(self, x, other, rounding_mode):
        return torch.ops.aten.div_.Scalar_mode(x, other, rounding_mode)

mod = Torch_Ops_Aten_Div_ScalarModeModule()
