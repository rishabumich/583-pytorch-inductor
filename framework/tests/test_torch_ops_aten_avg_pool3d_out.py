...
class Torch_Ops_Aten_AvgPool3D_OutModule(torch.nn.Module):
    def forward(self, x, kernel_size, stride, padding, ceil_mode, count_include_pad, divisor_override, out):
        return torch.ops.aten.avg_pool3d.out(x, kernel_size, stride, padding, ceil_mode, count_include_pad, divisor_override, out=out)

mod = Torch_Ops_Aten_AvgPool3D_OutModule()
