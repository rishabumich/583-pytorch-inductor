...
class Torch_Ops_Aten_UpsampleBicubic2D_OutModule(torch.nn.Module):
    def forward(self, x, output_size, align_corners, scales_h, scales_w, out):
        return torch.ops.aten.upsample_bicubic2d.out(x, output_size, align_corners, scales_h, scales_w, out=out)

mod = Torch_Ops_Aten_UpsampleBicubic2D_OutModule()
