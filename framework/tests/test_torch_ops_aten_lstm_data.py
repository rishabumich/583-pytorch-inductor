...
class Torch_Ops_Aten_Lstm_DataModule(torch.nn.Module):
    def forward(self, data, batch_sizes, hx, params, has_biases, num_layers, dropout, train, bidirectional):
        return torch.ops.aten.lstm.data(data, batch_sizes, hx, params, has_biases, num_layers, dropout, train, bidirectional)

mod = Torch_Ops_Aten_Lstm_DataModule()
