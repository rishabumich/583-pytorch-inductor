...
class Torch_Ops_Aten_Eye_MModule(torch.nn.Module):
    def forward(self, n, m, dtype, layout, device, pin_memory):
        return torch.ops.aten.eye.m(n, m, dtype, layout, device, pin_memory)
