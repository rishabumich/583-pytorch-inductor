...
class Torch_Ops_Aten_AvgPool3DModule(torch.nn.Module):
    def forward(self, x, kernel_size, stride, padding, ceil_mode, count_include_pad, divisor_override):
        return torch.ops.aten.avg_pool3d(x, kernel_size, stride, padding, ceil_mode, count_include_pad, divisor_override)

mod = Torch_Ops_Aten_AvgPool3DModule()
