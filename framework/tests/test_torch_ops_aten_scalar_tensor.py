...
class Torch_Ops_Aten_ScalarTensorModule(torch.nn.Module):
    def forward(self, s, dtype, layout, device, pin_memory):
        return torch.ops.aten.scalar_tensor(s, dtype, layout, device, pin_memory)
