...
class Torch_Ops_Aten_UpsampleNearest3D_OutModule(torch.nn.Module):
    def forward(self, x, output_size, scales_d, scales_h, scales_w, out):
        return torch.ops.aten.upsample_nearest3d.out(x, output_size, scales_d, scales_h, scales_w, out=out)
