...
class Torch_Ops_Aten_MaxPool2DWithIndices_OutModule(torch.nn.Module):
    def forward(self, x, kernel_size, stride, padding, dilation, ceil_mode, out, indices):
        return torch.ops.aten.max_pool2d_with_indices.out(x, kernel_size, stride, padding, dilation, ceil_mode, out=out, indices)
