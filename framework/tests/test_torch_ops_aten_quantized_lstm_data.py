...
class Torch_Ops_Aten_QuantizedLstm_DataModule(torch.nn.Module):
    def forward(self, data, batch_sizes, hx, params, has_biases, num_layers, dropout, train, bidirectional, dtype, use_dynamic):
        return torch.ops.aten.quantized_lstm.data(data, batch_sizes, hx, params, has_biases, num_layers, dropout, train, bidirectional, dtype, use_dynamic)

mod = Torch_Ops_Aten_QuantizedLstm_DataModule()
