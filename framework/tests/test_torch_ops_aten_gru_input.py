...
class Torch_Ops_Aten_Gru_InputModule(torch.nn.Module):
    def forward(self, input, hx, params, has_biases, num_layers, dropout, train, bidirectional, batch_first):
        return torch.ops.aten.gru.input(input, hx, params, has_biases, num_layers, dropout, train, bidirectional, batch_first)

mod = Torch_Ops_Aten_Gru_InputModule()
